                                ...
                                <div class="mb-3">
                                    <div class="input_wrap d-flex flex-column">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control mt-2 edit_ans inputStatus" placeholder="回答" disabled>${callBackData[i].Asked}</textarea>
                                        </div>    
                                    </div>
                                    <div class="form-group">
                    ...
                    if ($('.setupBlock').hasClass('active')) {
                        ...
                        $('.btnDel').on('click', function (e) {
                            ...
                            if (confirm("您確定要刪除這則問答嗎？")) {
                                ...
                                xhr.open('DELETE', `${URL}FAQ/${id}`, true)
                                xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
                                xhr.send($.param(dataObj));
                            }
                        });
